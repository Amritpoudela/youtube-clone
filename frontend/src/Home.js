...
import apnacollege from './images/apnacollege.jpg'
        ...
        <div>
            ...
            <div class="main-section">
                <div class="main-left">
                    ...
                    <button class="yt-side-button">
                        <img src={SRK} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">SRK</span>
                    </button>
                    <button class="yt-side-button">
                        <img src={apnacollege} height={'30px'} width={'30px'}></img>
